import shippingPolicy from './shippingPolicy.json' with { type: 'json' }
...
export const policies = {
  shipping: {
    ...
    sections: [
      ...
      ['Rates and timing', `Shipping is ${(shippingPolicy.rateCents / 100).toFixed(2)}. Orders with a discounted product subtotal of ${shippingPolicy.freeThresholdCents / 100} or more receive free shipping. The usual transit estimate is ${shippingPolicy.transitMinDays}-${shippingPolicy.transitMaxDays} business days after processing; carrier estimates are not guarantees.`],
